...
import 'property_unit_created_screen.dart';

class UnitStatus extends StatefulWidget {
  const UnitStatus({Key? key}) : super(key: key);

  @override
  State<UnitStatus> createState() => _UnitStatusState();
}
...
class _UnitStatusState extends State<UnitStatus> {
          ...
          child: Padding(
            ...
            child: Column(
              ...
              children: [
                ...
                Text(
                  'Is this unit occupied or not occupied',
                  textAlign: TextAlign.center,
                  style: TextStyle(
                    color: Colors.grey,
                    fontSize: Sizes.w18,
                ...
                Row(
                  ...
                  children: [
                    GestureDetector(
                      ...
                      child: options('Occupied', box1, title1, border1),
                    ),
                    customVerticalDivider(),
                    GestureDetector(
                      onTap: () {
                        setState(() {
                          optionSelected = 'unoccupied';
                          title2 = titleSelect;
                          box2 = selectColor;
                          border2 = selectColor;
                          title1 = Colors.black;
                      ...
                      child: options('Unoccupied', box2, title2, border2),
                    )
                  ],
                ),
  ...
  proceed() {
    Navigator.of(context)
        .push(MaterialPageRoute(builder: (context) => const Finished()));
  }
